...
public class CommentLetterVO {
	...
	public CommentLetterVO(){}
	public CommentLetterVO(int comment_count, int comment_bno, String comment_date, String comment_content, String comment_writer,
			int comment_cno) {
		super();
